...
![img](assets/Mysql数据库管理系统/1683018751241-02c75051-5c96-4c4e-8d89-f01327c7ac2d.png)
...
![img](assets/Mysql数据库管理系统/1683018753799-595eec38-a10d-4394-b671-e9db338be5d0.png)



![img](assets/Mysql数据库管理系统/1683018753791-863e2caa-6d5e-481d-8a02-a230a3c7bb50.png)
...
![img](assets/Mysql数据库管理系统/1683018756504-2d6cc0a3-5303-4653-8100-a0d145064d42.png)
...
案例：
mysql> grant all privileges on qf.t1 to feige@'localhost' identified by '123456';
在user、db表中，均查询不到feige用户有select权限。在tables_priv表中，可查询到
```
...
![img](assets/Mysql数据库管理系统/1683018756906-eef24908-906e-40b9-aa59-bb7fff74c202.png)
...
[root@youngfit ~]# mkdir /var/log/mysql-bin
[root@youngfit ~]# chown mysql.mysql /var/log/mysql-bin/
[root@youngfit ~]# systemctl restart mysqld
```
...
```
查看binlog日志：开启之后等一会
[root@youngfit mysql]# mysqlbinlog mylog.000001 -v
# at 4     #时间的开始位置
...
![img](assets/Mysql数据库管理系统/1683018757083-291b614d-c1e3-4221-8fe8-eab35fa9e448.png)
...
![img](assets/Mysql数据库管理系统/1683018757185-e08f625f-6b34-46d9-a4a2-50933b9bf367.png)
...
![img](assets/Mysql数据库管理系统/1683018759194-74c29aa5-894a-4ea8-8cd7-98569845cc72.png)
...
![img](assets/Mysql数据库管理系统/1683018759194-2422d3d5-e7bc-498a-b910-2e773034a30b.png)
...
![img](assets/Mysql数据库管理系统/1683018759587-e89cee5c-4f43-4f10-b340-eed3f0f02345.png)
...
![img](assets/Mysql数据库管理系统/1683018759875-1a62b441-a06b-480e-bfd6-d8479388d470.png)



![img](assets/Mysql数据库管理系统/1683018759886-99bc3a43-7158-49f0-a4be-2145ed8b43d8.png)



![img](assets/Mysql数据库管理系统/1683018760600-0a353c06-3926-4da4-80cc-fdb665808f5f.png)
...
[root@mysql-server ~]# yum -y install percona-xtrabackup-24.x86_64  #一定要下载这个版本
[root@mysql-server ~]# innobackupex -v
xtrabackup: recognized server arguments: --datadir=/var/lib/mysql 
innobackupex version 2.4.23 Linux (x86_64) (revision id: 3320f39)
```
...
![img](assets/Mysql数据库管理系统/1683018761715-6abc71f7-d2bf-4166-8e69-7cc78832cc20.png)
...
![img](assets/Mysql数据库管理系统/1683018761630-f07c3d38-af93-4804-9ebb-3a6b5bf7bcf4.png)
...
![img](assets/Mysql数据库管理系统/1683018761711-1383365c-ca2d-4fc5-96aa-4106257d0744.png)
...
![img](assets/Mysql数据库管理系统/1683018762203-7a04a7d1-eed6-4c41-ac20-22c1fb717073.png)
...
![img](assets/Mysql数据库管理系统/1683018762304-e50bb096-9d1e-4ce3-8f1e-369827f1d3f2.png)
...
![img](assets/Mysql数据库管理系统/1683018763497-61349669-3873-4e00-8892-d965809e6790.png)
...
![img](assets/Mysql数据库管理系统/1683018763506-0179541f-fc7a-4c92-b6a6-79a5eb29362a.png)
...
![img](assets/Mysql数据库管理系统/1683018763552-a3889fb1-5cd1-4430-9a89-7d9fb023b56e.png)
...
![img](assets/Mysql数据库管理系统/1683018763601-d8adad6e-9a3d-4eda-849b-6448764ad91e.png)
...
![img](assets/Mysql数据库管理系统/1683018763852-82fc51e1-a77e-4105-974d-9f986cb43a08.png)
...
![img](assets/Mysql数据库管理系统/1683018764815-834aea2f-efe0-4a55-8d3a-3ef53885f1fb.png)
...
![img](assets/Mysql数据库管理系统/1683018765023-ee2787d8-dc39-4e27-9da8-655c511bfae3.png)
...
![img](assets/Mysql数据库管理系统/1683018765087-3ad7739a-0070-4a38-b64a-ecea0e194435.png)
...
![img](assets/Mysql数据库管理系统/1683018765184-f6bcdfbb-a50e-4c45-8514-5ca3bca2b365.png)
...
![img](assets/Mysql数据库管理系统/1683018765206-c72d6f1b-b9e1-414d-b1e5-98cef2be812d.png)
...
![img](assets/Mysql数据库管理系统/1683018766711-51dca848-a42e-4aab-b28f-2402691ad5d7.png)
...
![img](assets/Mysql数据库管理系统/1683018767310-ff3df9fb-1bf7-4af2-83e4-e9c4fe2e44d6.png)
...
![img](assets/Mysql数据库管理系统/1683018767096-5b3b5b72-6709-442c-9164-395cbc0f1d08.png)
...
![img](assets/Mysql数据库管理系统/1683018767132-6979d060-30ff-430a-aa2e-07c632b44eb1.png)
...
![img](assets/Mysql数据库管理系统/1683018767234-36be42cf-4d00-4b80-b049-e60010475292.png)
...
![img](assets/Mysql数据库管理系统/1683018767976-a993f7c6-9d0a-4baa-9a6f-375251b94002.png)
...
![img](assets/Mysql数据库管理系统/1683018768380-f8ecb629-5369-4b5d-bf8f-6596a458701e.png)
...
![img](assets/Mysql数据库管理系统/1683018768721-ef05f64a-3c9a-4ddc-ab5e-d7c925efe042.png)
...
![img](assets/Mysql数据库管理系统/1683018768820-230ed62e-49e1-423f-aac2-703a115bcabd.png)
...
![img](assets/Mysql数据库管理系统/1683018768898-78cca47b-6ce7-4bdc-a23e-56c067777b75.png)
...
![img](assets/Mysql数据库管理系统/1683018769598-cb5a6569-4485-4cb3-972c-7a0523fb6317.png)



![img](assets/Mysql数据库管理系统/1683018769760-48f7280f-e944-44a5-9543-2ba414a2555e.png)
...
![img](assets/Mysql数据库管理系统/1683018771449-bb8a63d6-8ee2-4f28-bdc1-c09828a94198.png)
...
![img](assets/Mysql数据库管理系统/1683018771386-02bdafc3-420c-4c38-945c-7c3f26fcdf62.png)
...
![img](assets/Mysql数据库管理系统/1683018771460-3c4bbbd4-9d37-40da-be41-29ac6c29469e.png)
...
![img](assets/Mysql数据库管理系统/1683018771311-3712e864-a6b7-4b2c-b9de-eafc393d1c9d.png)
...
![img](assets/Mysql数据库管理系统/1683018771582-e71d5c43-5bee-4dad-8231-054fb397968f.png)



![img](assets/Mysql数据库管理系统/1683018772328-cb0c9e36-bee5-4cf9-bed5-1da1d405c1a6.png)



![img](assets/Mysql数据库管理系统/1683018772722-3646a22c-fe30-4b49-ba43-ccc0aec7795b.png)
...
![img](assets/Mysql数据库管理系统/1683018772636-fdcc24a5-ca99-45a3-a992-bae7a02555ae.png)
...
```
将master当做mycat的客户端
[root@mysql-master ~]# mysql -uyoungfit -h mysql-mycat -p'Qf@456789' -P 8066
```



![img](assets/Mysql数据库管理系统/1683018772811-5fae5f90-2696-4637-abea-f7f51f47e93d.png)



![img](assets/Mysql数据库管理系统/1683018772870-27736ed5-6a4e-48aa-9935-02712a56072d.png)



![img](assets/Mysql数据库管理系统/1683018773688-476a7ccb-fe98-4255-a46a-439552af742f.png)



![img](assets/Mysql数据库管理系统/1683018773922-cd2d7581-5e9d-4c76-a000-0c5f81774ef5.png)
